package servlet.bigtest.author;
...
import servlet.bigtest.User;
import servlet.bigtest.UtilTools;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (user.getUsername() != null) {
                ...
                PreparedStatement ps = connection.prepareStatement(UtilTools.sql);
